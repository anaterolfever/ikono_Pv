// Mismo contenido que console-preview-pd-description.js (sin "Algunas de las salas").
// Pega en F12 → Console en https://feverup.com/m/465628 (recomendado), GitHub Pages o index local.
...
(function () {
  ...
  if (!el) { console.warn('No se encontró el contenedor de descripción. Abre https://feverup.com/m/465628 o la página demo.'); return; }
  ...
  if (location.hostname.indexOf('feverup.com') !== -1) {
    if (!document.getElementById('ikono-pv-preview-fonts')) {
      ...
      lf.rel = 'stylesheet';
      lf.href = 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Montserrat:wght@400;600&display=swap';
    ...
    if (!document.getElementById('ikono-pv-preview-css')) {
      ...
      lk.rel = 'stylesheet';
      lk.href = 'https://anaterolfever.github.io/ikono_Pv/assets/css/styles.css';
...
`;
  ...
  console.log('Descripción actualizada (sin salas). Contenedor:', el.id || el.className || el.tagName);
})();
